Class: Ecotone\PHPEncryption\File
==========================
...
- `Ecotone\PHPEncryption\Exception\IOException` is thrown if there is an I/O error.

- `Ecotone\PHPEncryption\Exception\EnvironmentIsBrokenException` is thrown either when
...
- `Ecotone\PHPEncryption\Exception\WrongKeyOrModifiedCiphertextException` is thrown if
...
Be aware that when `Ecotone\PHPEncryption\WrongKeyOrModifiedCiphertextException` is
