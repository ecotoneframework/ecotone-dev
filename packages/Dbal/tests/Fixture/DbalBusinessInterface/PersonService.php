...
{
    #[DbalWriteMethod('INSERT INTO persons VALUES (:personId, :name, DEFAULT)')]
    ...
    #[DbalWriteMethod('UPDATE persons SET name = :name WHERE person_id = :personId')]
    public function changeName(int $personId, string $name): int;

    /**
     * @param string[] $roles
     */
    #[DbalWriteMethod('UPDATE persons SET roles = :roles WHERE person_id = :personId')]
    ...
    #[DbalWriteMethod('INSERT INTO persons VALUES (:personId, :name, :roles)')]
