...
use Ecotone\Messaging\Endpoint\InboundChannelAdapter\InboundChannelTaskExecutor;
...
class InterceptedTaskConsumerRunner implements EndpointRunner
{
    ...
    public function createConsumer(?ExecutionPollingMetadata $executionPollingMetadata): ConsumerLifecycle
    {
        ...
        $executor = new InboundChannelTaskExecutor(
            $interceptedGateway,
            $this->serviceToCall,
            $this->methodName,
        );
