...
class InMemoryEventStoreRegistrationTest extends TestCase
{
    public function test_registers_in_memory_event_store_stream_source_when_pdo_event_sourcing_is_disabled(): void
    {
        ...
        $projection = new #[GlobalProjection('test_projection', runningMode: Projection::RUNNING_MODE_POLLING, endpointId: 'test_projection_poller')] class ($testEvent) {
            public array $events = [];
    ...
    public function test_does_not_register_in_memory_stream_source_when_custom_stream_source_is_provided(): void
    {
        ...
        $projection = new #[GlobalProjection('test_projection', runningMode: Projection::RUNNING_MODE_POLLING, endpointId: 'test_projection_poller')] class {
            public array $events = [];
            public int $callCount = 0;
