...
class EventStreamingProjectionTest extends TestCase
{
    public function test_event_streaming_projection_consuming_from_streaming_channel(): void
    {
        ...
        $projection = new #[GlobalProjection('user_projection', runningMode: Projection::RUNNING_MODE_EVENT_STREAMING, streamingChannelName: 'streaming_channel')] class {
    ...
    public function test_event_streaming_projection_with_multiple_event_handlers_routed_by_name(): void
    {
        ...
        $projection = new #[GlobalProjection('order_projection', runningMode: Projection::RUNNING_MODE_EVENT_STREAMING, streamingChannelName: 'streaming_channel')] class {
    ...
    public function test_event_streaming_projection_with_event_store_channel_adapter(): void
    {
        ...
        // Given a projection that consumes from streaming channel
        $projection = new #[GlobalProjection('product_projection', runningMode: Projection::RUNNING_MODE_EVENT_STREAMING, streamingChannelName: 'event_stream')] class {
    ...
    public function test_two_event_streaming_projections_consuming_from_same_channel_separately(): void
    {
        ...
        $productListProjection = new #[GlobalProjection('product_list_projection', runningMode: Projection::RUNNING_MODE_EVENT_STREAMING, streamingChannelName: 'event_stream')] class {
        ...
        $productPriceProjection = new #[GlobalProjection('product_price_projection', runningMode: Projection::RUNNING_MODE_EVENT_STREAMING, streamingChannelName: 'event_stream')] class {
    ...
    public function test_event_driven_projection_combined_with_event_streaming_projection(): void
    {
        ...
        $eventDrivenProjection = new #[GlobalProjection('event_driven_product_count', automaticInitialization: true)] class {
        ...
        $eventStreamingProjection = new #[GlobalProjection('streaming_product_list', runningMode: Projection::RUNNING_MODE_EVENT_STREAMING, streamingChannelName: 'event_stream')] class {
            public array $productList = [];
