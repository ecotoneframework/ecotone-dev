...
namespace Test\Ecotone\EventSourcing\Fixture\TicketWithPollingProjectionAndOptions;
...
#[Projection(self::IN_PROGRESS_TICKET_PROJECTION, Ticket::class, options: ['persist_block_size' => 1])]
