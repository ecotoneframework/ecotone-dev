 ...
 * The new ProjectionV2 system doesn't have an equivalent configuration option for metadata matching at the stream source level.
 *
...
final class ProjectionWithMetadataMatcherTest extends TestCase
{
    public function test_skipped_metadata_matcher_not_supported_in_new_system(): void
    {
        $this->markTestSkipped(
            ...
            'The new ProjectionV2 system does not have an equivalent configuration option for metadata matching.'
        );
    }
}
