...
final class AsynchronousEventDrivenProjectionTest extends ProjectingTestCase
{
    ...
    private function createAsyncProjection(): object
    {
        ...
        return new #[ProjectionV2(self::NAME), ProjectionScopeConfig(MessageHeaders::EVENT_AGGREGATE_ID), Asynchronous(self::CHANNEL), FromStream(stream: Ticket::class, aggregateType: Ticket::class)] class($connection) {
