...
final class EmittingEventsProjectionTest extends EventSourcingMessagingTestCase
{
    ...
    {
        return new #[ProjectionV2('partitioned_emitting_projection'), ProjectionScopeConfig(MessageHeaders::EVENT_AGGREGATE_ID), FromStream(stream: Ticket::class, aggregateType: Ticket::class)] class() {
    ...
    {
        return new #[ProjectionV2('partitioned_emitting_linked_projection'), ProjectionScopeConfig(MessageHeaders::EVENT_AGGREGATE_ID), FromStream(stream: Ticket::class, aggregateType: Ticket::class)] class() {
