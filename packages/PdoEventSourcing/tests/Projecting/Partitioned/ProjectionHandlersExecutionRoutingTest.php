...
class ProjectionHandlersExecutionRoutingTest extends EventSourcingMessagingTestCase
{
    ...
    public function test_partitioned_projection_having_same_event_registered_differently(): void
    {
        ...
        $projection = new #[ProjectionV2('partitioned_projection_with_multiple_handlers'), CustomScopeConfiguration(MessageHeaders::EVENT_AGGREGATE_ID), FromStream(stream: AnAggregate::STREAM_NAME, aggregateType: AnAggregate::class)] class {
            public array $events = [];
    ...
    {
        return new #[ProjectionV2('partitioned_projection_with_object_routing'), CustomScopeConfiguration(MessageHeaders::EVENT_AGGREGATE_ID), FromStream(stream: AnAggregate::STREAM_NAME, aggregateType: AnAggregate::class)] class {
            public array $events = [];
    ...
    {
        return new #[ProjectionV2('partitioned_projection_with_regex_routing'), CustomScopeConfiguration(MessageHeaders::EVENT_AGGREGATE_ID), FromStream(stream: AnAggregate::STREAM_NAME, aggregateType: AnAggregate::class)] class {
            public array $events = [];
    ...
    {
        return new #[ProjectionV2('partitioned_projection_with_multiple_handlers'), CustomScopeConfiguration(MessageHeaders::EVENT_AGGREGATE_ID), FromStream(stream: AnAggregate::STREAM_NAME, aggregateType: AnAggregate::class)] class {
            public array $events = [];
