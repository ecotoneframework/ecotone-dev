...
use Test\Ecotone\SqsDemo\AbstractConnectionTest;

class ChannelAdapterTest extends AbstractConnectionTest
{
    ...
    /**
     * @param ConsumerLifecycle $inboundChannelAdapter
     * @param QueueChannel $requestChannel
     * @return Message|null
     */
    private function receiveMessage(ConsumerLifecycle $inboundChannelAdapter, QueueChannel $requestChannel)
    {
