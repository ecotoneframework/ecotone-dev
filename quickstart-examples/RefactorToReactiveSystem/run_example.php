...
if ($stageToRun !== 'Stage_1') {
    $messagingSystem->run("asynchronous", ExecutionPollingMetadata::createWithDefaults()->withTestingSetup(handledMessageLimit: 2, executionTimeLimitInMilliseconds: 60000));
}