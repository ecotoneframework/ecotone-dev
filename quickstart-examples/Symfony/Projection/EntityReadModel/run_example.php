...
echo "== Symfony Projection Quickstart - Entity Read Model ==\n\n";
...
$messagingSystem->runConsoleCommand('ecotone:projection:delete', ['name' => 'user_list_entity']);
...
$messagingSystem->runConsoleCommand('ecotone:projection:backfill', ['name' => 'user_list_entity']);
$rows = $queryBus->sendWithRouting('user.listActive');
Assert::assertCount(1, $rows);
Assert::assertSame('Alice Cooper', $rows[0]['name']);
